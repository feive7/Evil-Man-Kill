static GameMap MAP_NOSTALGIA = {
	...
	{ // Walls
		...
		{ // concretewall.001
			.points = {{6.0f,8.0f},{6.0f,18.0f},{-4.0f,18.0f},{-4.0f,8.0f}},
			.z = 8.0f,
			.height = 2.0f,
			.texture = &TEX_BRICK,
		...
		{ // stone.002
			.points = {{-4.0f,6.0f},{-4.0f,18.0f},{-6.0f,18.0f},{-6.0f,6.0f}},
			.z = 2.5f,
			.height = 7.5f,
			.texture = &TEX_BRICK,
			.tint = {60,60,60,255},
		...
		{ // token
			.points = {{0.5f,-36.5f},{0.5f,-35.5f},{-0.5f,-35.5f},{-0.5f,-36.5f}},
			.z = -11.5f,
			.height = 1.0f,
			.texture = &TEX_TILE_6,
			.tint = {255,255,0,255},
		...
		{ // token.001
			.points = {{-23.5f,-48.5f},{-23.5f,-47.5f},{-24.5f,-47.5f},{-24.5f,-48.5f}},
			.z = 0.5f,
			.height = 1.0f,
			.texture = &TEX_TILE_6,
			.tint = {255,255,0,255},
		...
		{ // token.002
			.points = {{-11.5f,11.5f},{-11.5f,12.5f},{-12.5f,12.5f},{-12.5f,11.5f}},
			.z = 0.5f,
			.height = 1.0f,
			.texture = &TEX_TILE_6,
			.tint = {255,255,0,255},
